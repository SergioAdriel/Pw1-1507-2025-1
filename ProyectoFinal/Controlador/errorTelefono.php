        ...
        <div class="card">
            <div class="card-content">
                <div class="center-align">
                    ...
                    <!-- Mensaje que indica que el número de teléfono ya está registrado -->
                    <p>El número de teléfono ya está registrado. Por favor, utiliza otro número o verifica tus datos.</p>
